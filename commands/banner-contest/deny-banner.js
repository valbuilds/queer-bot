...
module.exports = {
    data: new SlashCommandBuilder()
        .setName(`deny-banner-submission`)
        .setDescription(`Denies banner submissions.`)
    ...
    async execute(interaction) {
        ...
        const reply = new EmbedBuilder()
            .setTitle(`:negative_squared_cross_mark: Denied`)
        ...
        async function finalize() {
            ...
            await channel.setAppliedTags([`1107667009388425336`, `1108411094776676372`]);
